 ...
 * [ecocore.yml](ecocore.yml)
     * Determines how your purl.obolibrary.org/obo/ecocore/ redirects will be handled
     ...
     * Paste in the contents of [ecocore.yml](ecocore.yml)
 ...
 * [ecocore.md](ecocore.md)
     ...
     * Paste in the contents of [ecocore.md](ecocore.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
